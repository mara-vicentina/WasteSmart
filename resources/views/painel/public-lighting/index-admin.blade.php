    ...
    <div class="row">
        ...
        <div class="col-md-2 col-sm-5">
            <div class="card-body fs-5">
                <button type="button" class="btn btn-primary custom-button" data-bs-toggle="modal" data-bs-target="#ticket-message">
...
<div class="card mx-5 p-2 shadow overflow-auto custom-card pr-5 py-2">
    <p class="fs-5 sec-color mb-2">Acompanhamento dos Ticketsss</p>
    <table class="table">
        <thead>
            <tr>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="col subtitle-list text-left">
                    <div class="row">
                        <div class="col-6 p-0">
                            <button id="button-see-ticket-" class="btn btn-link" onclick="seeTicket()">
